...
public class BootTest {
	 ...
	 * 
	 * @Test public void testCode01() { System.out.println(homeController.home());
	 * 
	 * }
	 */
	...
	public void testCode02() {
		/*
		 * Builder xx =BuilderVO.builder(); xx= xx.setAge(10); xx= xx.setName("홍길동");
		 * 
		 * BuilderVO vo=xx.build(); System.out.println(vo.toString());
		 */
